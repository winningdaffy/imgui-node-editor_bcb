...
struct Platform
{
    ...
    virtual bool ApplicationStart() = 0;
    virtual void ApplicationStop() = 0;

    virtual bool OpenMainWindow(const char *title,
                                int is_child_wnd,
                                void *parent_handle,
                                int width,
                                int height) = 0;
    ...
    virtual void set_window_size(int32_t x,
                                 int32_t y,
                                 int32_t width,
                                 int32_t height) = 0;

    bool HasWindowScaleChanged() const
    {
        return m_WindowScaleChanged;
    }
    void AcknowledgeWindowScaleChanged()
    {
    ...
    bool HasFramebufferScaleChanged() const
    {
    ...
    float GetFramebufferScale() const
    {
